...
import 'package:stonwallet/src/core/rest_client/src/http/check_exception_io.dart'
    if (dart.library.js_interop) 'package:stonwallet/src/core/rest_client/src/http/check_exception_browser.dart';
